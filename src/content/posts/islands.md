...
subtitle: "Scuba, Whale Sharks & Island Hopping in the Gulf of Thailand"
date: 2026-02-15
...
<div class="island-stats">
  <div class="island-stats-header">🏝️ Koh Tao at a Glance</div>
  <div class="island-stats-grid">
    <div class="island-stat"><span class="stat-value">~8</span><span class="stat-label">sq miles</span></div>
    <div class="island-stat"><span class="stat-value">15 min</span><span class="stat-label">north to south</span></div>
    <div class="island-stat"><span class="stat-value">8 min</span><span class="stat-label">east to west</span></div>
    <div class="island-stat"><span class="stat-value">1,500</span><span class="stat-label">residents</span></div>
  </div>
</div>
...
<div class="timeline-card">
  <div class="timeline-header">🏝️ Koh Tao: A Brief History</div>
  <div class="timeline-item"><span class="timeline-year">Pre-1933</span><span class="timeline-desc">Uninhabited tropical paradise</span></div>
  <div class="timeline-item prison"><span class="timeline-year">1933–1941</span><span class="timeline-desc">Political prison (yes, really)</span></div>
  <div class="timeline-item"><span class="timeline-year">1947</span><span class="timeline-desc">Prison abandoned, prisoners moved to mainland</span></div>
  <div class="timeline-item"><span class="timeline-year">1980s</span><span class="timeline-desc">Western travelers discover the island</span></div>
  <div class="timeline-item"><span class="timeline-year">Today</span><span class="timeline-desc">World-class scuba diving destination</span></div>
</div>
...
<div class="cert-card">
  <div class="cert-header">🤿 PADI Open Water Certification</div>
  <div class="cert-body">
    <div class="cert-row"><span>Cost</span><span>$354</span></div>
    <div class="cert-row"><span>Includes</span><span>All gear, 4 dives, bro tank</span></div>
    <div class="cert-row"><span>Bro tank status</span><span>Stolen by Ryker</span></div>
    <div class="cert-row"><span>Max depth</span><span>50 ft</span></div>
    <div class="cert-row highlight"><span>Bonus encounter</span><span>🦈 WHALE SHARK</span></div>
  </div>
</div>
...
<div class="eight-limbs">
  <div class="eight-limbs-header">🥊 The Art of Eight Limbs</div>
  <div class="eight-limbs-grid">
    <div class="limb">🤜 Right fist</div>
    <div class="limb">🤛 Left fist</div>
    <div class="limb">🦵 Right kick</div>
    <div class="limb">🦵 Left kick</div>
    <div class="limb">💪 Right elbow</div>
    <div class="limb">💪 Left elbow</div>
    <div class="limb">🦿 Right knee</div>
    <div class="limb">🦿 Left knee</div>
  </div>
</div>
...
<div class="progress-bar-card">
  <div class="progress-header">🌍 Trip Progress</div>
...
<style>
/* Island Stats Card */
.island-stats { background: linear-gradient(135deg, #0a3d5e 0%, #1a6b8a 100%); border-radius: 16px; padding: 1.5rem; margin: 2rem 0; color: white; }
.island-stats-header { font-size: 1.3rem; font-weight: 800; margin-bottom: 1rem; }
.island-stats-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 12px; }
.island-stat { background: rgba(255,255,255,0.1); border-radius: 10px; padding: 12px; text-align: center; }
.stat-value { display: block; font-size: 1.5rem; font-weight: 800; }
.stat-label { display: block; font-size: 0.7rem; opacity: 0.7; text-transform: uppercase; letter-spacing: 0.05em; }

/* Timeline */
.timeline-card { background: linear-gradient(135deg, #1a1a2e, #16213e); border-radius: 16px; padding: 1.5rem; margin: 2rem 0; color: white; }
.timeline-header { font-weight: 800; font-size: 1.1rem; margin-bottom: 1rem; }
.timeline-item { display: flex; gap: 1rem; padding: 0.5rem 0; border-left: 3px solid #00C9A7; padding-left: 1rem; margin-left: 0.5rem; font-size: 0.85rem; }
.timeline-item.prison { border-left-color: #e74c3c; }
.timeline-year { font-weight: 700; min-width: 80px; color: #7ecfea; }
.timeline-desc { opacity: 0.85; }

/* Certification Card */
.cert-card { max-width: 380px; margin: 2rem auto; background: linear-gradient(135deg, #0a3d5e, #1a6b8a); border-radius: 16px; overflow: hidden; color: white; }
.cert-header { padding: 1rem; text-align: center; font-weight: 800; font-size: 1.1rem; background: rgba(0,0,0,0.2); }
.cert-body { padding: 1rem 1.2rem; }
.cert-row { display: flex; justify-content: space-between; padding: 0.4rem 0; font-size: 0.85rem; border-bottom: 1px solid rgba(255,255,255,0.1); }
.cert-row:last-child { border-bottom: none; }
.cert-row.highlight { color: #FFD93D; font-weight: 700; }

/* Eight Limbs */
.eight-limbs { max-width: 380px; margin: 2rem auto; background: linear-gradient(135deg, #FF3CAC, #e74c3c); border-radius: 16px; padding: 1.5rem; color: white; }
.eight-limbs-header { text-align: center; font-weight: 800; font-size: 1.1rem; margin-bottom: 1rem; }
.eight-limbs-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 8px; }
.limb { background: rgba(255,255,255,0.15); padding: 8px 12px; border-radius: 8px; font-size: 0.8rem; text-align: center; }
...
/* Whale Shark Reveal */
.whale-shark-reveal img { border-radius: 12px; border: 4px solid #0a3d5e; }
.whale-shark-reveal figcaption { font-style: italic; color: #666; text-align: center; }
</style>
